...
/* Define to 1 if you have the declaration of `gnutls_fingerprint', and to 0
   if you don't. */
/* #undef HAVE_DECL_GNUTLS_FINGERPRINT */
...
/* Define to 1 if you have the <vlc/vlc.h> header file. */
/* #undef HAVE_VLC_VLC_H */
...
/* Expanded configuration directory */
