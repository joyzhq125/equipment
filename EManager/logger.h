...
#define EM_SQL_BATCH_SIZE       50                  // Limit the size of multi-row SQL statements
#define EM_SQL_SML_BUFSIZ       256                 // Size of SQL buffer
#define EM_SQL_MED_BUFSIZ       1024                // Size of SQL buffer
#define EM_SQL_LGE_BUFSIZ       8192                // Size of SQL buffer
...
public:
    ...
    public:
        ...
        Options( Level termLevel=DEBUG9, Level databaseLevel=NOLOG, Level fileLevel=DEBUG9, Level syslogLevel=NOLOG, const std::string &logPath=".", const std::string &logFile="" ) :
...
#define logHexdump(logLevel,data,len)  {\
	...
	//Logger::fetch()->mMutex.lock();
	//Logger::fetch()->mMutex.unlock();
